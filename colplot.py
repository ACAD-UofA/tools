    ...
    with open(args.infile) as f:
        ...
        for line in f:
            ...
            if args.horiz_column > 0:
                x.append(float(fields[args.horiz_column-1]))
            y.append(float(fields[args.vert_column-1]))
...
def parse_args():
    ...
    parser.add_argument("-x", "--horiz-column", type=int, default=-1, help="1-based column to plot on horizontal axis")
    ...
    parser.add_argument("--scatter", action="store_true", default=False, help="scatter plot [%(default)s]")
...
if __name__ == "__main__":
    ...
    if args.scatter:
        ax1.scatter(x, y, edgecolor="none")
    else:
        ax1.plot(x, y)
